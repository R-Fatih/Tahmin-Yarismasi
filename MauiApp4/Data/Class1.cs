...
namespace MauiApp4.Data
{
    ...
    //
    {
        ...
        public System.Drawing.Color HexToColor(String hexString)
        ...
        //  the color white will be returned.
        {
            ...
            if ((hexString.StartsWith("#")) && (hexString.Length == 7))
            {
                ...
                actColor = System.Drawing.Color.FromArgb(r, g, b);
            }
            else
            {
                actColor = System.Drawing.Color.White;
            }
            return actColor;
        }

        public String ColorToHex(System.Drawing.Color actColor)
